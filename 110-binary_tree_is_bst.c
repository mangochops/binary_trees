...
/**
 * check_sub_tree_Left - Check if all nodes in the left subtree are smaller or equal.
 * @node: Node in the tree to verify condition.
 * @max: Value to compare.
 * Return: 1 if all nodes are smaller or equal, 0if not.
 */
...
/**
 * check_sub_tree_Right - Check if all nodes in the right subtree are bigger or equal.
 * @node: Node in the tree to verify condition.
